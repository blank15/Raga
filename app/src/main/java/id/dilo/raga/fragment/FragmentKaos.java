...
public class FragmentKaos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=LayoutInflater.from(getContext()).inflate(R.layout.fragment_kaos, container, false);
        recyclerView = view.findViewById(R.id.rvKaos);
        ...
        dataMerchandise.add(new DataMerchandise(R.drawable.ic_kaos, "Real Madrid","Rp. 150.000"));
